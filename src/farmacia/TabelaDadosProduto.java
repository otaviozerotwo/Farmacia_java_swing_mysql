 ...
 * @author lies
 */
public class TabelaDadosProduto extends javax.swing.JFrame {

    /**
     * Creates new form TabelaDadosProduto
     */
    public TabelaDadosProduto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta Cadastro de Produto");
        ...
        tabelaProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "DESCRIÇÃO", "EAN", "CLASSIFICAÇÃO", "FABRICANTE", "MS", "UNIDADE MEDIDA", "TIPO RECEITA", "COR RECEITA", "PRINCÍPIO ATIVO", "POSOLOGIA"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TabelaDadosProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TabelaDadosProduto().setVisible(true);
            }
        });
    }
