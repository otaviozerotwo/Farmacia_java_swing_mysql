...
public class ExcluirCliente extends javax.swing.JFrame {
    ...
    private void tabelaDadosClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaDadosClienteMouseClicked
        ...
        if(resposta == 0){
            ...
            Integer id = (Integer)tabelaDadosCliente.getValueAt(linha, 0);
            DAOCliente remover = new DAOCliente();
            
            if(remover.removerCliente(id)){
                JOptionPane.showMessageDialog(null, "Registro removido com sucesso!");
                DefaultTableModel modeloRemoveLinha = (DefaultTableModel)tabelaDadosCliente.getModel(); 
                modeloRemoveLinha.removeRow(tabelaDadosCliente.getSelectedRow());  
                tabelaDadosCliente.setModel(modeloRemoveLinha);
            }else{
